...
<!-- Plugin CSS -->
<link rel="stylesheet"
	href="resources/thirdparty/creative/css/animate.min.css"
	type="text/css">

<!-- Custom CSS -->
<link rel="stylesheet"
	href="resources/thirdparty/creative/css/creative.css" type="text/css">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a id="document_link">Document List</a></li>
					<li><a id="kashiwade_link">KASHIWADE</a></li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2 text-center">
					...
					<hr class="light">
					<p class="text-faded">The association between design documents
						and workflow is described by metadata based on semantic Web
						technology. This system offers a workflow editor to create and
						edit workflow.</p>
				</div>
			</div>
		</div>
	...
	<section class="no-padding" id="portfolio">
		<div class="container-fluid">
			<div class="row no-gutter">
				...
				<div class="col-lg-4 col-sm-6">
					<a href="http://heineken.is.k.u-tokyo.ac.jp/forest3/"
						class="portfolio-box"> <img
	...
	<aside class="bg-dark">
		<div class="container text-center">
			<div class="call-to-action">
				<h2>GitHub</h2>
				<a href="https://github.com/pineplain/sfweb"
					class="btn btn-default btn-xl wow tada">Download Now!</a>
			</div>
		</div>
	</aside>
	...
	<script type="text/javascript">
		jQuery(document).ready(
				function() {
					...
					$("#document_link").attr("href",
							KASHIWADE_BASE_URL + "common/resourceList");
