...
public abstract class DataObject {
		...
		for (String key : keys) {
			...
			if (rePredicates != null) {
				for (String rePredicate : rePredicates) {
					if (predicate.equals(SF.NS + rePredicate))
						flag = "false";
				}
			}
	...
	/**
	 * @param rePredicates
	 *            the rePredicates to set
	 */
	public void setRePredicates(List<String> rePredicates) {
		this.rePredicates = rePredicates;
	}

	protected void postSVO(String url, String subject, String predicate,
			String object, String flag) {
		try {
